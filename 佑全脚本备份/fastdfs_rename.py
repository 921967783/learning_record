...
test_dict={}
finaList=[]
fileName='portList201901.txt'
newFileName='portList201902.txt'
...
date = '201902'
date_final = '20192'
text3 = "find ./ -name '*test1*' -type f|sed 's/\(.*\)\(test2\)\(.*\)\(.conf\)/mkdir  \/fastdfs2\/storage_data\/20192\/storagetest3\\3/'|sh"
